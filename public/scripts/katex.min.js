!(function (e, t) {
    ...
    return (function () {
                ...
                if (l) {
                    ...
                    if ("boldsymbol" === l) {
                        const t = (function (e, t, r, n, o) {
                            return "textord" !== o &&
                                Ne(e, "Math-BoldItalic", t).metrics
                                ? {
        ...
        const Ke = function (e) {
            ...
            lt = function (e, t) {
                return e
                    ? (t && (e = at(e, t)), nt[e.classes[0]] || null)
                    : null;
            },
            ht = function (e, t) {
        ...
        const bt = function (e, t, r) {
            ...
            xt = function (e, t) {
                ...
                return N(o, Pe.fontMap[r].fontName, n)
                    ? Pe.fontMap[r].variant
                    : null;
            };
        function wt(e) {
            if (!e) return !1;
                ...
                for (let r = 0; r < e.length; r++) {
                    ...
                    if (s instanceof dt && o instanceof dt) {
                        ...
                        if ("mn" === s.type && wt(o))
                            ...
                            e instanceof dt &&
                                "mn" === e.type &&
                                ((e.children = [...o.children, ...e.children]),
                                n.pop());
        ...
        function Ot(e) {
            return e && ("atom" === e.type || ne.hasOwnProperty(e.type))
                ? e
                : null;
        }
        const Et = (e, t) => {
        ...
        const Jt = function (e, t, r) {
            ...
            ar = function (e, t, r, n, o, s) {
                ...
                return Qt(
                    Pe.makeSpan(["delimsizing", "mult"], [C], B),
                    w.TEXT,
                    n,
                    s,
                );
                ...
                htmlBuilder: (e, t) => {
                    ...
                    if (
                        ...
                        (n =
                            "." === e.left
                                ? ht(t, ["mopen"])
                                : wr.leftRightDelim(e.left, s, i, t, e.mode, [
                                      "mopen",
                                  ])),
                        r.unshift(n),
                        a)
                    ...
                    if ("." === e.right) o = ht(t, ["mclose"]);
                        ...
                        o = wr.leftRightDelim(e.right, s, i, r, e.mode, [
                            "mclose",
                        ]);
                    }
        ...
        Br({
            ...
            Br({
                ...
                handler(e, t) {
                    const r = (
                        Ot(t[0]) ? [t[0]] : Rt(t[0], "ordgroup").body
                    ).map(function (e) {
                        const t = Ht(e).text;
                        if (-1 !== "lc".indexOf(t))
                            return { type: "align", align: t };
        ...
        Ze({
            ...
            mathmlBuilder(e, t) {
                ...
                return (
                    (r = new ft.MathNode("mtext", [new ft.TextNode("\xa0")])), r
                );
            },
        });
        const dn = () => {
        ...
        Nr("\\dots", function (e) {
            ...
            return (
                r in qn
                    ...
                    : ("\\not" === r.slice(0, 4) ||
                          (r in se.math &&
                              l.contains(["bin", "rel"], se.math[r].group))) &&
                      (t = "\\dotsb"),
                t
            );
        });
                    ...
                    if ("\\limits" === e.text || "\\nolimits" === e.text) {
                        ...
                        if (!Dn[e.text]) break;
                        {
                            const t = Ln.test(e.text),
                                n = [];
                            for (
                                n.push(new Ir(Dn[e.text])), this.consume();
                                ;
