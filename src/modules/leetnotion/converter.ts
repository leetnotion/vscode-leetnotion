...
import {
	CreateProblemPageProperties,
	LeetcodeProblem,
	LeetnotionSubmission,
	UpdateProblemPageProperties,
} from '../../types';
...
export class LeetCodeToNotionConverter {
	...
	static convertProblemToUpdatePage(problem: LeetcodeProblem) {
		const solution = JSON.parse(JSON.stringify(problem.solution)) as OfficialSolution | null;
	...
	static convertSubmissionToSubmissionPage(
